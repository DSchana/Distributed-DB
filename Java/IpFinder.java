...
public class IpFinder{
    ...
    public static String getPublicIP(){
        String ip="";
        try{ 
            String[] ipBots={"http://checkip.amazonaws.com/","http://icanhazip.com/","http://www.trackip.net/ip",
            "http://myexternalip.com/raw", "http://ipecho.net/plain", "http://bot.whatismyipaddress.com"};
